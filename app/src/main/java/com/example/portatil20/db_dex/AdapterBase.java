...
public class AdapterBase extends BaseAdapter {
    ...
    protected ArrayList<Chars> clases;

    public AdapterBase(Activity activity, ArrayList<Chars> clases) {
        super();
    ...
    public void addAll(ArrayList<Chars> persons2Add) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            Chars clase = clases.get(i);
            TextView name = (TextView) v.findViewById(R.id.textViewname);
           name.setText(clase.getName());
